...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<body>
            ...
            <ul>
                ...
                <li class="submenu open">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="ApprovalRecord.action">查看审批记录</a></li>
		...
		<div id="content">
			...
			<form action="chaxun.action" method="post" name="searchForm">
					...
					<div class="widget-box">
						<div class="widget-content nopadding">
							<table class="table table-bordered table-striped">
								...
								<tbody>
								<c:forEach var="ed" items="${employee}">
                                    <tr>
                                        <td>${ed.employeeName}</td>
                                        <td>${ed.holidayTypeName}</td>
                                        <td>${ed.takeOffDays}</td>
                                        <td><fmt:formatDate value="${ed.startDay}" pattern="yyyy年MM月dd日"/> - <fmt:formatDate value="${ed.endDay}" pattern="yyyy年MM月dd日"/></td>
                                        <td>
                                            <button class="btn btn-info" onclick="allmessage(${ed.takeOffID})">
                                                <i class="icon-white icon-eye-open"></i>
                                                详细
                                            </button>
                                            <script type="text/javascript">
											  function allmessage(id){
                                                   location.href="chakan3.action?id="+id;
                                               }
