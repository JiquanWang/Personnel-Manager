						...
						<div class="span12">
							<div class="widget-box">
								...
								<div class="widget-content nopadding">
									<form id="eform" action="addHeadship.action" class="form-horizontal" method="post" />
	                                    <div id="info1" class="control-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="text" name="headshipName" id="jname" />
	                                        </div>
	                                    </div>
	                                    <div id="info2" class="control-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="number" name="headshipLevel" id="jlevel"/>
	                                        </div>
	                                    </div>
