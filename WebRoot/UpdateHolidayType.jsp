						...
						<div class="span12">
							<div class="widget-box">
								...
								<div class="widget-content nopadding">
									<form id="eform" action="vUpdate.action" class="form-horizontal" method="post" />
	                                    <div id="info1" class="control-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="text" name="holidayTypeName" id="jname" value="${list1.holidayTypeName}"/>
	                                            <input type="text" name="holidayTypeID" id="jname" value="${list1.holidayTypeID}"  style="visibility:hidden"/>
	                                        </div>
	                                    </div>
