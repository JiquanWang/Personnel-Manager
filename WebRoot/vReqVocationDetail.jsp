                            ...
                            <table width="100%">
                            	<tr>
                                    ...
                                    <td width="60%" align="left">
                                    	&nbsp;&nbsp;
                                    	${todv.employeeName}(员工编号${todv.employeeID})
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        &nbsp;&nbsp;
                                        <fmt:formatDate value="${todv.startDay}" pattern="yyyy年MM月dd日"/> - <fmt:formatDate value="${todv.endDay}" pattern="yyyy年MM月dd日"/>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        &nbsp;&nbsp;
                                        <fmt:formatDate value="${todv.applyDay}" type="both" pattern="yyyy年MM月dd日  HH时mm分ss秒" />
                                    </td>
                                    <td></td>
                                </tr>
                            </table>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
	                                <c:forEach var="u" items="${ltoev}">
	                                    <tr>
	                                        <td>${u.examineLevel}</td>
	                                        <td>${u.examinerName}</td>
	                                        <td>${u.examineOpinion}</td>
	                                        <td>
	                             <fmt:formatDate value="${u.examineDate}" type="both" pattern="yyyy年MM月dd日  HH时mm分ss秒" />
	                                        </td>
	                                        <td>${u.examineResult}</td>
	                                    </tr>
	                                </c:forEach>
                                </tbody>
                            </table>    
