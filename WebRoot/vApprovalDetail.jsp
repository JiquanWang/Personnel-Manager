...
<head>
		...
		<script src="js/jquery.min.js"></script>
       	...
       	<script type="text/javascript">
       		function bohui(id){
       			location.href="bohui.action?id="+id+"&opinion="+$("#txa1").val();
       		}
       		
       		function tongguo(id){
               	location.href="tongguo.action?id="+id+"&Opinion="+$("#txa1").val();
			}
       	</script>
</head>
	<body>
						...
						<div class="widget-box">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        &nbsp;&nbsp;
                                       <textarea id="txa1" style="width:200px;height:100px;resize:none;"></textarea>
                                    </td>
                                    <td></td>
                                </tr>
                                 <tr>
                                    <td></td>
                                    <td>
                                        <button class="btn btn-success" id="btn_1" onclick="tongguo(${employee.takeOffID})">
                                            <i class="icon-white icon-refresh"></i>
                                            通过
                                        </button>
                                        <button class="btn btn-danger" id="btn_2" onclick="bohui(${employee.takeOffID})">
