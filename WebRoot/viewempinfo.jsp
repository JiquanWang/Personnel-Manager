						...
						<div class="widget-box">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                    	&nbsp;&nbsp;
                                    	${empInfo.headshipName}(${empInfo.headshipLevel})
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                    	&nbsp;&nbsp;
                                    	<fmt:formatDate value="${empInfo.hireDate}" pattern="yyyy年MM月dd日"/>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                    	&nbsp;&nbsp;
                                    	<fmt:formatDate value="${empInfo.birthday}" pattern="yyyy年MM月dd日"/>
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
